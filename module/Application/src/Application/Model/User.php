...
class User {
	public $user_id, $database_id, $username, $password, $email_address, $role, $profile_photo, $facebook_username, $twitter_username, $disable_account, $metadata, $create_date, $update_time;
