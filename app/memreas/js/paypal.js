...
var payPalSubscribe_url = '/index/payPalSubscribe';
	  	...
	  	if (json.Status == "Success") {
	  		for (var i=0;i<json.payment_methods.length;i++)
			{
				html_str +=
						...
						'<td>paypal ref id:' +
						'<td><input type="text" class="card_numbers" id="paypal_card_reference_id_' + i + '" name="paypal_card_reference_id_' + i + '" value="'+ json.payment_methods[i].paypal_card_reference_id + '">' +
						'<td>card type:' +
